...
void set_fc_effect(void)
{
    ...
    else if (DEVICE_OFF == fc_effect.on_off_flag)
    {
        fc_effect.Now_state = NOW_STATUS_CLOSE;
        ...
        WS2812FX_setSegment_colorOptions(
            ...
            &meteor_lights_close_effect, // 效果
            WHITE,                       // 颜色， WS2812FX_setColors 设置
            0,                           // 速度
...
void custom_effect(void)
{
    ...
    u8 meteor_effect_options = NO_OPTIONS;
    ...
    WS2812FX_setSegment_colorOptions(
        ...
        fc_effect.speed,        // 速度
        meteor_effect_options); // 选项，这里像素点大小：3 REVERSE决定方向
    WS2812FX_start();
}
